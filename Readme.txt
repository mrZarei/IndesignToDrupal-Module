...
** All the images class which is going to place in a textarea field should be start with "img_".
** The Images value can contain "Image text" and "Image Byline". In order to do this value can be split by "*", in the way that first
   ...
   ex: pic1.jpg*some texts*photo by mrz =>  image name:pic1.jpg , image text: some texts, image_byline:photo by mrz
   ex  pic1.jpg**photo by mrz => example of value without image text.
